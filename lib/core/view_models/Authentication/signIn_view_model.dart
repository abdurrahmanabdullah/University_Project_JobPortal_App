...
import 'package:ecommerce/core/services/Authentication/sign_in.dart';
...
class SignInViewModel extends BaseViewModel {
  ...
  final SignIn _authenticationAPI = locator<SignIn>();
  ...
  Future<bool>? signInAPI() async {
    ...
    int? returnedStatusCode = await _authenticationAPI.signInSendRequest(
